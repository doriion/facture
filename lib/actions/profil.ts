...
export async function upsertProfil(
  ...
  const payload = {
    ...
    decennale_valide_jusquau: v.decennale_valide_jusquau || null,
    decennale_activites: v.decennale_activites || null,
    fluides_valide_jusquau: v.fluides_valide_jusquau || null,
