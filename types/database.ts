    ...
    Tables: {
      ...
      contrats: {
        Row: {
          ...
          rappel_visite_envoye_pour: string | null;
          created_at: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contrats_maintenance_id_fkey";
            columns: ["maintenance_id"];
            isOneToOne: false;
            referencedRelation: "contrats_maintenance";
            referencedColumns: ["id"];
          },
        ];
      };
